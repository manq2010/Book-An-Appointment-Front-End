...
const Item = ({ data }) => {
  ...
  const remove = '../../assets/remove.svg';
  ...
  return (
    <article className="Item flex flex-col md:flex-row items-center justify-start text-center bg-orange rounded-xl px-4">
      <div className="Item-image w-45 md:w-56 h-45 md:h-56 relative flex flex-col justify-center md:w-64 md:h-64">
        <img
          src={data.photo}
          alt={`${data.name}`}
